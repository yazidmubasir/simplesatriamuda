...
MASTER_KELAS:[['id','ID','TEXT'],['spreadsheet_id','ID Spreadsheet Kelas','TEXT'],['admin_user_id','Admin User ID','TEXT'],['status','Status','TEXT'],['created_at','Dibuat','DATETIME'],['updated_at','Diubah','DATETIME']],
